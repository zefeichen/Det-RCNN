...
from lib.util.misc import inverse_sigmoid
from models.deformable_DETR.ops.modules import MSDeformAttn
from models.deformable_DETR.transformer import _get_clones, _get_activation_fn

class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8, bh = False,
        ...
        if bh:
            self.decoder_head = DeformableTransformerDecoder(decoder_layer, num_decoder_layers, return_intermediate_dec)
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, targets=None):
        ...
        return hs, memory, init_reference_out, inter_references, spatial_shapes, valid_ratios, mask_flatten
...
def build_deforamble_transformer(args):
    ...
    return DeformableTransformer(
        d_model=args.deformable_detr.hidden_dim,
        nhead=args.deformable_detr.nheads,
        bh = args.model_cfg.bh,
        num_encoder_layers=args.deformable_detr.enc_layers,
        num_decoder_layers=args.deformable_detr.dec_layers,
        dim_feedforward=args.deformable_detr.dim_feedforward,
        dropout=args.train_cfg.dropout,
        activation="relu",
        return_intermediate_dec=True,
        num_feature_levels=num_feature_levels,
        dec_n_points=args.deformable_detr.dec_n_points,
        enc_n_points=args.deformable_detr.enc_n_points,
        two_stage=args.model_cfg.two_stage)
